...
/**
 * Interface supported by {@link org.apache.jxtadoop.io.WritableComparable}
...
public abstract class BinaryComparable implements Comparable<BinaryComparable> {
   ...
   * @see org.apache.jxtadoop.io.WritableComparator#compareBytes(byte[],int,int,byte[],int,int)
   */
   ...
   * @see org.apache.jxtadoop.io.WritableComparator#hashBytes(byte[],int)
   */
  public int hashCode() {
