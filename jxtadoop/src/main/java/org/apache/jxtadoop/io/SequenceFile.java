...
import org.apache.jxtadoop.fs.ChecksumFileSystem;
...
import org.apache.jxtadoop.fs.LocalDirAllocator;
import org.apache.jxtadoop.fs.Path;
import org.apache.jxtadoop.fs.s3.VersionMismatchException;
import org.apache.jxtadoop.hdfs.p2p.P2PConstants;
import org.apache.jxtadoop.io.compress.CodecPool;
import org.apache.jxtadoop.io.compress.CompressionCodec;
import org.apache.jxtadoop.io.compress.CompressionInputStream;
import org.apache.jxtadoop.io.compress.CompressionOutputStream;
...
import org.apache.jxtadoop.io.compress.GzipCodec;
import org.apache.jxtadoop.io.compress.zlib.ZlibFactory;
import org.apache.jxtadoop.io.serializer.Deserializer;
import org.apache.jxtadoop.io.serializer.SerializationFactory;
import org.apache.jxtadoop.io.serializer.Serializer;
import org.apache.jxtadoop.util.Progressable;
import org.apache.jxtadoop.util.Progress;
import org.apache.jxtadoop.util.ReflectionUtils;
import org.apache.jxtadoop.util.NativeCodeLoader;
import org.apache.jxtadoop.util.MergeSort;
import org.apache.jxtadoop.util.PriorityQueue;
...
public class SequenceFile {
   ...
   * @deprecated Use 
   *             {@link org.apache.jxtadoop.mapred.SequenceFileOutputFormat#getOutputCompressionType(org.apache.jxtadoop.mapred.JobConf)} 
   ...
   *             {@link org.apache.jxtadoop.mapred.SequenceFileOutputFormat#setOutputCompressionType(org.apache.jxtadoop.mapred.JobConf, org.apache.jxtadoop.io.SequenceFile.CompressionType)}
  ...
  public static class Reader implements java.io.Closeable {
    ...
    private void handleChecksumException(ChecksumException e)
      ...
      if (this.conf.getBoolean("io.skip.checksum.errors", false)) {
        ...
        sync(getPosition()+this.conf.getInt("io.bytes.per.checksum", P2PConstants.IO_BYTES_PER_CHECKSUM));
      } else {
        throw e;
      }
    }
  ...
  public static class Sorter {
    ...
    public class SegmentDescriptor implements Comparable {
      ...
      public boolean nextRawKey() throws IOException {
        if (in == null) {
          int bufferSize = conf.getInt("io.file.buffer.size", P2PConstants.IO_FILE_BUFFER_SIZE); 
          if (fs.getUri().getScheme().startsWith("ramfs")) {
            bufferSize = conf.getInt("io.bytes.per.checksum", P2PConstants.IO_BYTES_PER_CHECKSUM);
          }
