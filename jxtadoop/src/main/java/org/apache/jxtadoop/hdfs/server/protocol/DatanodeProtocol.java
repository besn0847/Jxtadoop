...
public interface DatanodeProtocol extends VersionedProtocol {
   ...
   * Register Datanode.
   *
   * @see org.apache.jxtadoop.hdfs.server.datanode.DataNode#dnRegistration
   * @see org.apache.jxtadoop.hdfs.server.namenode.FSNamesystem#registerDatanode(DatanodeRegistration)
   * 
   * @return updated {@link org.apache.jxtadoop.hdfs.server.protocol.DatanodeRegistration}, which contains 
  ...
  /**
   * same as {@link org.apache.jxtadoop.hdfs.protocol.ClientProtocol#reportBadBlocks(LocatedBlock[])}
   * }
   */
