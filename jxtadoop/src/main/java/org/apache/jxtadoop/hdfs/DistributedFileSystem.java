...
import org.apache.jxtadoop.hdfs.DFSClient.DFSOutputStream;
...
public class DistributedFileSystem extends FileSystem {
  ...
  /** @deprecated */
  public DistributedFileSystem(Configuration conf) throws IOException {
    String peer = NameNode.getNameNode().getNameNodePeerID().toString().replaceAll("urn:jxta:cbid-","");
    URI uri = null;;
  ...
  public void initialize(URI uri, Configuration conf) throws IOException {
    ...
    if(DFSClient.getDfsClient() == null)
    	this.dfs = new DFSClient(conf, statistics);
    else 
    	this.dfs=DFSClient.getDfsClient();
    
    this.uri = NameNode.getUri(dfs.getDfsClientPeer().getRpcSocketAddress());
   ...
   *  
   * @see org.apache.jxtadoop.hdfs.protocol.ClientProtocol#setSafeMode(
   ...
   * 
   * @see org.apache.jxtadoop.hdfs.protocol.ClientProtocol#saveNamespace()
   */
