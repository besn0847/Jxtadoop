 ...
 */
package org.apache.jxtadoop.hdfs.tools;
...
import org.apache.jxtadoop.fs.FsShell;
import org.apache.jxtadoop.fs.Path;
import org.apache.jxtadoop.fs.shell.Command;
import org.apache.jxtadoop.fs.shell.CommandFormat;
import org.apache.jxtadoop.hdfs.DistributedFileSystem;
...
public class DFSAdmin extends FsShell {	
  ...
  public DFSAdmin(Configuration conf) {
    ...
    this.dfspeer = new DFSClientPeer("DFS ADM - "+ System.getProperty("jxtadoop.datanode.id"));
  }
  ...
  public int refreshServiceAcl() throws IOException {
    ...
    RefreshAuthorizationPolicyProtocol refreshProtocol = 
      ...
      RPC.getProxy(RefreshAuthorizationPolicyProtocol.class, 
                   ...
                   dfspeer.getPeerGroup(), dfspeer.getRpcSocketAddress(), getUGI(conf), conf,
