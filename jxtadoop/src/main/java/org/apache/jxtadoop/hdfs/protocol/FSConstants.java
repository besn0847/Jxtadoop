...
public interface FSConstants {
  ...
  public static final int BUFFER_SIZE = new Configuration().getInt("io.file.buffer.size", P2PConstants.IO_FILE_BUFFER_SIZE);
  ...
  public static final int DEFAULT_DATA_SOCKET_SIZE = 128 * 512;
